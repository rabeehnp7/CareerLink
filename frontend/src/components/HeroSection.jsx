...
function HeroSection() {
  ...
  return (
    <div className="text-center">
      <div className="flex flex-col gap-5 my-10 mt-5">
        ...
        <div className="text-center">
        <p className="text-xl md:text-2xl lg:text-3xl font-bold text-purple-600 bg-purple-100 px-4 py-2 rounded-md shadow-md">Opportunities Await You</p>
        </div>
